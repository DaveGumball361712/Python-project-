...
forest=py.image.load("forest.png").convert_alpha()
forest=py.transform.scale(forest,(TILE,TILE))
fields=py.image.load("fields.png").convert_alpha()
fields=py.transform.scale(fields,(TILE,TILE))
rocks=py.image.load("Rocks.png").convert_alpha()
rocks=py.transform.scale(rocks,(TILE,TILE))
water=py.image.load("water.png").convert_alpha()
water=py.transform.scale(water,(TILE,TILE))
logo=py.image.load("logo-ptit.png").convert_alpha()
